...
public class Step3Main {
	...
	public static void main(String[] args) {
        ...
        for ( i=n; i<=0; i--)
        {
        	double transformPrice = Double.parseDouble(data[i][1]) ;	
            double deger = transformPrice;
            double deg;
            int dongusayisi = 0;
            int j = i-1;
            int min = i-1;
	            while (j>=0 &&  Double.parseDouble(data[j][1]) > deger)
	            {
	            	...
	            	j = j-1;
	            	deg = Double.parseDouble(data[j+1][1]); 
