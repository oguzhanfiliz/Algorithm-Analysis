...
public class Step3Main 
{
    public static void main(String[] args) {
		...
		//newArray'de sadece dolarlarým mevcut
    	...
    	if(maxcontrolPrice < maxControlPriceSecond) {
    		...
    		System.out.println("Satabileceðiniz tarih : "+maxDateSecond );
    		if(minControlPriceSecond<mincontrolPrice) {
    			System.out.println("Alabileceðiniz en kaarlý dolar kuru" +minControlPriceSecond );
    			System.out.println("Alabileceðiniz tarih : "+minDateSecond);
