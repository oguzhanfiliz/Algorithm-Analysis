...
public class HelloWorld {
	 ...
	 public static void main(String[] args)  {
			...
			for(int control=0; control<data.length; control++) {
				
				double transformPrice = Double.parseDouble(data[control][1]) ;				
				
				if(maxcontrolPrice < transformPrice) {
					maxcontrolPrice = transformPrice;
					maxDate = data[control][0];
				}
				
				if(mincontrolPrice > transformPrice) {
					mincontrolPrice = transformPrice;
					minDate = data[control][0];
				}
